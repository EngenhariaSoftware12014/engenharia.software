...
--
-- Host: localhost:8889
-- Generation Time: May 27, 2014 at 08:46 AM
...
--
-- Dumping data for table `1_jogadas`
--

INSERT INTO `1_jogadas` (`idjogadas`, `usuario_idusuario`, `numero_dado`, ` casa_andada`, `tipo_suspeita`, `alvo_suspeita`, `resposta_carta`, `resposta_usuario`) VALUES
(1, 9, 4, '', '', 0, 0, 0);
...
--
-- Table structure for table `1_suspeitosxposicao`
--

CREATE TABLE `1_suspeitosxposicao` (
...
--
-- Dumping data for table `1_suspeitosxposicao`
--

INSERT INTO `1_suspeitosxposicao` (`idsuspeito`, `position_x`, `position_y`) VALUES
(2, 4, 13),
(3, 13, 13),
(4, 10, 22),
(5, 3, 4),
...
INSERT INTO `comodos` (`idcomodos`, `nome`, `imagem`, `position_x`, `position_y`, `class`, `delete_2`) VALUES
(3, 'Casa Dona Florinda', 'florinda_casa.png', 3, 4, 'restaurant', NULL),
(4, 'Casa Bruxa do 71', 'bruxa_casa.png', 4, 13, 'prefecture', NULL),
(5, 'Casa Seu Madruga', 'madruga_casa.png', 4, 22, 'bank', NULL),
(6, 'Pátio', 'patio.png', 13, 13, 'square', NULL),
(7, 'Fonte', 'fonte.png', 10, 22, 'office', NULL),
(8, 'Lanchonete', 'lanchonete.png', 9, 3, 'hospital', NULL),
(9, 'Barraca de Churros', 'barraca_churros.png', 23, 3, 'graveyard', NULL),
(10, 'Escola', 'escola.png', 16, 23, 'mansion', NULL),
(11, 'Terreno Baldio', 'terreno_badio.png', 23, 13, 'station', NULL),
(12, 'Entrada', 'entrada_vila.png', 16, 3, 'floriculture', NULL),
(14, 'Mercado', 'mercado.png', 23, 22, 'nightclub', NULL);
...
INSERT INTO `partidas` (`idpartida`, `status`, `vencedor`, `current_player`) VALUES
(1, '2', NULL, 1);
